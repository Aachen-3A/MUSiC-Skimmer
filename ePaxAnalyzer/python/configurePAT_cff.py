...
photonMatch.maxDPtRel = cms.double(1.0), 
jetMatch.checkCharge = cms.bool(False),
jetMatch.resolveByMatchQuality = cms.bool(True),
jetMatch.maxDeltaR = cms.double(0.2),  
jetMatch.maxDPtRel = cms.double(3.0), 
