...
void MUSiCSkimmer::analyzeGenInfo(const edm::Event& iEvent, pxl::EventView* EvtView, std::map<const Particle*, pxl::Particle*>& genmap ) {
...
void MUSiCSkimmer::analyzeGenJets(const edm::Event& iEvent, pxl::EventView* EvtView, std::map<const Particle*, pxl::Particle*> & genjetmap) {
...
void MUSiCSkimmer::analyzeTrigger(const edm::Event& iEvent, pxl::EventView* EvtView) {
...
void MUSiCSkimmer::analyzeRecMuons(const edm::Event& iEvent, pxl::EventView* RecView, const bool& MC, std::map<const Particle*, pxl::Particle*> & genmap) {
...
void MUSiCSkimmer::analyzeRecElectrons(const edm::Event& iEvent, pxl::EventView* RecView, bool& MC, EcalClusterLazyTools& lazyTools, std::map<const Particle*, pxl::Particle*> & genmap) {
...
void MUSiCSkimmer::analyzeRecJets(const edm::Event& iEvent, pxl::EventView* RecView, bool& MC, std::map<const Particle*, pxl::Particle*>& genjetmap) {
...
void MUSiCSkimmer::analyzeRecGammas(const edm::Event& iEvent, pxl::EventView* RecView, bool& MC, EcalClusterLazyTools& lazyTools, std::map<const Particle*, pxl::Particle*> & genmap){
